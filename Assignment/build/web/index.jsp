    ...
    <body>
            ...
            <div class="container px-5">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        <li class="nav-item"><a class="nav-link active" aria-current="page" href="index.jsp">Trang ch?</a></li>
                        <li class="nav-item"><a class="nav-link active" aria-current="page" href="login.html">??ng nh?p</a></li>
                    </ul>
                </div>
            </div
        </nav>
        ...
        <div id="frontpage-banner">
            <div id="frontpage-banner-content">
               ...
               <a href="#search-box" class="m-3 btn btn-primary" role="button">View more</a>
            </div>           
        </div>
        <!-- Search Box -->
